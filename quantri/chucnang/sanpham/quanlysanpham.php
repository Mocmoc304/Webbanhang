...
<br>
<div style="width:990px;text-align:left" >
	Chọn : <select name="danh_muc" onchange="window.location='?thamso=sanpham&id_menu='+this.value" >
...
<table width="900px" class="tb_a1" >
	<tr style="background:#CCFFFF;height:40px;" >
		...
		<td align="center" width="110px" ><b>Giá</b></td>
		<td align="center" width="110px" ><b>Sửa</b></td>
		<td align="center" width="110px" ><b>Xóa</b></td>
	</tr>
	<?php 
		while($tv_2=mysqli_fetch_array($tv_1))
		{
	...
	<tr>
		<td colspan="5" align="center" >
			...
			<?php 
				...
				{
					$link_phan_trang="?thamso=sanpham&id_menu=".$id_menu."&trang=".$i;
